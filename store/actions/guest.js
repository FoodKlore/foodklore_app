...
export const GUEST_CONFIRMED_ACCOUNT_SUCCESS =
    'GUEST_CONFIRMED_ACCOUNT_SUCCESS'
export const GUEST_CONFIRMED_ACCOUNT_FAILURE =
    'GUEST_CONFIRMED_ACCOUNT_FAILURE'
